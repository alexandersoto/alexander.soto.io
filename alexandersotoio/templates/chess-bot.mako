...
<div class="container project-container">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <p> Alpha-beta pruning works best when there is good move ordering. If you try the best move first, all subsequent moves will fail to improve the score and most of the game tree will be pruned away. Most enhancements to chess programs focus on improving move ordering. Because there are substantially fewer nodes at depth n-1 than n, we can use the results from prior searches to improve move ordering. This process is called <a href="https://chessprogramming.wikispaces.com/Iterative+Deepening">iterative deepening</a> and is implemented in this bot.</p>
